...
int main()
{
    ...
    Shader screenShader1(VERTEX_SCREEN_FILE, FRAGMENT_SCREEN_FILE);
    Shader screenShader2(VERTEX_SCREEN_FILE, FRAGMENT_SCREEN_INVERSE_FILE);
    Shader screenShader3(VERTEX_SCREEN_FILE, FRAGMENT_SCREEN_GRAYSCALE_FILE);
    Shader screenShader4(VERTEX_SCREEN_FILE, FRAGMENT_SCREEN_SHARPEN_FILE);
    Shader screenShader5(VERTEX_SCREEN_FILE, FRAGMENT_SCREEN_BLUR_FILE);
    Shader screenShader6(VERTEX_SCREEN_FILE, FRAGMENT_SCREEN_EDGE_FILE);
