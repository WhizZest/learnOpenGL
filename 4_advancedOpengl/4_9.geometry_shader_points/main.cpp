...
int main()
{
    ...
    Shader pointsShader(VERTEX_NORMAL_FILE, FRAGMENT_NORMAL_FILE, GEOMETRY_FILE);

    // load models
    // -----------
    Model backpack(RESOURCES_DIR"/objects/babala/babala.pmx");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        model = glm::translate(model, glm::vec3(-5.0f, -10.0f, -22.0));
        if (g_bPointsRender)
        {
            pointsShader.use();
        ...
        ImGui::Checkbox("Points", &g_bPointsRender);
