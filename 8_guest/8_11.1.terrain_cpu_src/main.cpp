...
int main()
{
    ...
    // ------------------------------------
    Shader heightMapShader(VERTEX_FILE, FRAGMENT_FILE);
    ...
    unsigned char *data = stbi_load(RESOURCES_DIR"/../8_guest/8_11.1.terrain_cpu_src/heightmaps/iceland_heightmap.png", &width, &height, &nrChannels, 0);
    if (data)
    {
