...
int main()
{
	...
	// load models
	// -----------
	Model ourModel(RESOURCES_DIR"/objects/Breakdance 1990/Breakdance 1990.fbx");
	Animation danceAnimation(RESOURCES_DIR"/objects/Breakdance 1990/Breakdance 1990.fbx",&ourModel);
