...
int main()
{
    ...
    // -------------------------
    Shader shader(VERTEX_SHADOW_MAPING_FILE, FRAGMENT_SHADOW_MAPING_FILE);
    Shader simpleDepthShader(VERTEX_SHADOW_MAPING_DEPTH_FILE, FRAGMENT_SHADOW_MAPING_DEPTH_FILE, GEOMETRY_SHADOW_MAPING_DEPTH_FILE);
    Shader debugDepthQuad(VERTEX_DEBUG_QUAD_FILE, FRAGMENT_DEBUG_QUAD_FILE);
    Shader debugCascadeShader(VERTEX_DEBUG_CASCADE_FILE, FRAGMENT_DEBUG_CASCADE_FILE);
